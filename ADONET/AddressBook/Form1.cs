...
namespace AddressBook {
    public partial class Form1 : Form {
        ...
        private void btAdd_Click(object sender, EventArgs e) {
            DataRow newRow = infosys202217DataSet.AddressTable.NewRow();
            newRow[1] = tbName.Text;
            newRow[2] = tbAddress.Text;
            //データセットへ新しいレコードを追加
            infosys202217DataSet.AddressTable.Rows.Add(newRow);
            //データベース更新
            this.addressTableTableAdapter.Update(this.infosys202217DataSet.AddressTable);
        }
        //エラー回避
        ...
        private void btNameSerch_Click(object sender, EventArgs e) {
            addressTableTableAdapter.FillByName(infosys202217DataSet.AddressTable,tbSerchName.Text );
        }
        ...
        private void データベース接続ToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            this.addressTableTableAdapter.Fill(this.infosys202217DataSet.AddressTable);
        }
